...
public class MainActivity extends AppCompatActivity {
    ...
    // static - для доступа из нескольких активностей
    ...
    /**
     *
     * перейти NoteEditorActivity при нажатии на "Add note" ы меню
     */
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * удаление записки при длинном нажатии на нее
         */
